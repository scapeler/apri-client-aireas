...
//			'cbsBuurtRookRisicoInfoLayer':	{group: 'CBS', sortId: 1 }
		...
		'luftdaten': [ 
			{layer:{name:'luftDatenEurSmallLayer',			layerObjectName: 'luftDatenEurSmallLayer'},		group: 'LUFTD', sortId: 1,sensor: 'SDS011_PM25', 	label:'Luftdaten PM2.5', properties: {avgType:'SDS011_PM25'}}
		],
		'nsl': { 
