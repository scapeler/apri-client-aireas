...
//        var pdokLuchtfotoLayer = L.tileLayer.wms(siteProtocol+sitePrefixExtern+"geodata1.nationaalgeoregister.nl/luchtfoto/wms", {
        pdokLuchtfotoLayer = L.tileLayer.wms("https://geodata1.nationaalgeoregister.nl/luchtfoto/wms", {
...
*/
		...
		PDOK_BAG_verblijfsobject_Layer = L.tileLayer.wms("https://geodata.nationaalgeoregister.nl/bagviewer/wms", {
        // ?service=WMS&version=1.1.0&bbox=123657.03125,499459.625,129679.1328125,504556.78125&width=512&height=433&srs=EPSG:28992&format=
		...
		PDOK_BAG_pand_Layer = L.tileLayer.wms("https://geodata.nationaalgeoregister.nl/bagviewer/wms", {
        // ?service=WMS&version=1.1.0&bbox=123657.03125,499459.625,129679.1328125,504556.78125&width=512&height=433&srs=EPSG:28992&format=
            layers: 'pand',
            format: 'image/png',
            transparent: true,
		...
		Ahn1_5m_Layer = L.tileLayer.wms("https://geodata.nationaalgeoregister.nl/ahn1/wms", {
            layers: 'ahn1_5m',
            format: 'image/png',
            transparent: true,
			tiled: true,
...
*/
        ...
        nwbWegHectoPuntenLayer = L.tileLayer.wms("https://geodata.nationaalgeoregister.nl/nwbwegen/wms", {
        // ?service=WMS&version=1.1.0&bbox=123657.03125,499459.625,129679.1328125,504556.78125&width=512&height=433&srs=EPSG:28992&format=
            layers: 'hectopunten',
            format: 'image/png',
            transparent: true,
        ...
        nwbWegVakkenLayer = L.tileLayer.wms("https://geodata.nationaalgeoregister.nl/nwbwegen/wms", {
        // ?service=WMS&version=1.1.0&bbox=123657.03125,499459.625,129679.1328125,504556.78125&width=512&height=433&srs=EPSG:28992&format=
            layers: 'wegvakken',
            format: 'image/png',
            transparent: true,
...
//https://afnemers.ruimtelijkeplannen.nl/afnemers2012/services?&SERVICE=WMS&REQUEST=GetMap&VERSION=1.1.1&LAYERS=BP%3AEnkelbestemming&STYLES=&FORMAT=image%2Fpng&TRANSPARENT=true&HEIGHT=256&WIDTH=256&TILED=true&LEGENDPNG=http%3A%2F%2Fgeodata.nationaalgeoregister.nl%2Fplu%2Fwms%3Frequest%3DGetLegendGraphic%26version%3D1.3.0%26service%3DWMS%26layer%3DEnkelbestemming%26style%3DEnkelbestemming%26format%3Dimage%2Fpng&ZOOMTO=13&SRS=EPSG%3A28992&BBOX=156256.91706183183,378896.9353807878,159315.85097471345,381944.5079138001
		...
		//	tilesorigin: [-180, 90],
			...
			legendPng: "https://geodata.nationaalgeoregister.nl/plu/wms?request=GetLegendGraphic&version=1.3.0&service=WMS&layer=Enkelbestemming&style=Enkelbestemming&format=image/png",
			zoomTo: 12
        });
