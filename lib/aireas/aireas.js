...
//				ajaxGetData2(APRI.getConfig().urlSystemRoot + "/data/aireas/getCbsGemInfo/*",
				ajaxGetData2("http://localhost:4000/SCAPE604/openiod?SERVICE=WPS&REQUEST=Execute&identifier=pestinfo" , 
...
//			'cbsBuurtRookRisicoInfoLayer':	{group: 'CBS', sortId: 1 }
		...
		'wur': { 
			...
			'dankBurgerKeuzeBoomPlantWMSLayer':	{group: 'WUR', sortId: 1 }
		},
		'ov': { 
...
*/
	...
	var areaLayersPackagesList = {
		  'EHV': { layerPackages: {'aireas': true, 'cbs': true, 'wat': true  } } //,	 , 'ndw': true, 'ehv': true	'ov': true, 'divers': true } }
...
// ===============  Alterra WMS start
        dankBurgerKeuzeBoomPlantWMSLayer = new L.tileLayer.wms("http://geodata.rivm.nl/geoserver/dank/wms", {  //c5v511
        // ?service=WMS&version=1.1.0&bbox=123657.03125,499459.625,129679.1328125,504556.78125&width=512&height=433&srs=EPSG:28992&format=
            layers: 'ank_bomenkaart',
            format: 'image/png',
            transparent: true,
			tiled: false,
		//	styles: "aireasCELC",
		//	tilesorigin: [-180, 90],
			...
			//crs: L.CRS('EPSG:4326'),
			srs: 'EPSG:28992',
            attribution: "DANK Burgerkeuze boomplant 2016"
        });
// ===============  Alterra WMS end
...
//===========================================================================  end of constructor
	...
	var aireasHistGridGemLayer, aireasTileLayer, openBasisKaartLayer, PDOK_BAG_pand_Layer, pdokLuchtfotoLayer,
		...
		nslSegmentEindhovenWMSLayer, nslResultEindhovenWMSLayer, nslReceptorEindhovenWMSLayer, nslMeasureEindhovenWMSLayer, dankPm10InvangWMSLayer, dankWandelWMSLayer, dankFietsWMSLayer, dankLandBelevingWMSLayer, dankBodemMaatregelCTotaalWMSLayer, dankBomenWMSLayer, dankBiomassaHoutvoorraadWMSLayer, dankBoomHoogteWMSLayer, dankBiomassaTakTopSnoeiWMSLayer,dankBurgerKeuzeBoomPlantWMSLayer,
...
//		L.control.layers(aireasBaseMaps, aireasOverlayMaps).addTo(map);
		...
		var overlayAlterra = {
			...
			"Alterra Burger boomkeuze 2016": dankBurgerKeuzeBoomPlantWMSLayer
		};
